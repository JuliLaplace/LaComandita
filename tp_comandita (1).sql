...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2023 a las 23:55:01
...
INSERT INTO `detallepedido` (`id`, `codigopedido`, `idproducto`, `tiempocalculado`) VALUES
(1, '11re2', 4, '-00:00:01'),
(2, '11re2', 8, '-00:00:01');
...
INSERT INTO `empleados` (`id`, `sector`, `estado`, `clave`, `fechaCreacion`, `nombre`, `usuario`) VALUES
(1, 1, '1', 'abcsd', '2023-11-26', 'andrea', 'andrea2020'),
...
(14, 6, '1', 'nomade1', '2023-11-13', 'matias', 'mattnmd'),
(15, 6, '1', 'acro123', '2023-11-13', 'florencia', 'florricci');
...
INSERT INTO `pedidos` (`id`, `codigoPedido`, `idCliente`, `codigoMesa`, `idEmpleado`, `fecha`, `precioFinal`, `estado`) VALUES
(1, '11re2', 1001, '5f6ah', 2, '2023-11-10 17:20:12', 4400.00, 1);
...
INSERT INTO `productos` (`id`, `nombre`, `precio`, `sector`, `tiempopreparacion`, `estado`) VALUES
(1, 'mila', 5500, 2, '00:40:00', 'activo'),
(2, 'pizza fugazzeta', 3500, 2, '00:20:00', 'activo'),
(3, 'ensalada capresse', 1800, 2, '00:15:00', 'activo'),
(4, 'flan', 1500, 1, '00:30:00', 'activo'),
(5, 'helado', 1000, 1, '00:05:00', 'eliminado'),
(6, 'golden', 1700, 4, '00:09:00', 'activo'),
(7, 'stout', 1700, 4, '00:09:00', 'activo'),
(8, 'daikiri', 2900, 3, '00:15:00', 'activo'),
(9, 'papas fritas', 1000, 2, '00:05:00', 'activo');
