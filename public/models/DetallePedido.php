...
class DetallePedido{
    ...
    public function crearDetalleProducto()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO detallepedido (codigopedido, idproducto, tiempocalculado) VALUES (:codigopedido, :idproducto, :tiempocalculado, :estado)");
